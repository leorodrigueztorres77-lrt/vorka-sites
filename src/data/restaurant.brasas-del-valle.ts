...
// Capa 3 — Brasas del Valle (parrilla/asador, Valle de los Chillos). CLON DE
// DEMO con marca ficticia, derivado de Shangrila para mostrar el trabajo sin
// usar la marca real de un negocio con cuyo dueño aún no se ha hablado. Todo
// el contenido (menú, precios, historia, testimonios) es relleno razonable
// para el rubro (parrilla/asador), no datos de un negocio real. Si esto se
// vuelve un cliente real, reemplazar por datos verdaderos antes de publicar.
export const menuBrasasValle: CategoriaMenu[] = [
  {
    categoria: 'Entradas',
    platos: [
  ...
  },
  {
    ...
    platos: [
      {
        nombre: 'Parrillada Brasas del Valle',
...
export const horariosBrasasValle: HorarioDia[] = [
...
export const historiaBrasasValle: HistoriaNegocio = {
  texto:
    'En Brasas del Valle el carbón nunca se apaga: parrilladas servidas al punto, ' +
...
// brandkit.brasas-del-valle.ts, y se repetía 3 veces (hero + galería + menú) — ver
...
export const galeriaBrasasValle: FotoGaleria[] = [
  {
...
export const heroFotoBrasasValle =
...
export const testimoniosBrasasValle: Testimonio[] = [
  {
    nombre: 'Andrés Salazar',
    texto:
      'La parrillada Brasas del Valle no falla — llega calientita y las porciones son ' +
